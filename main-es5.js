...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 2,
      consts: [["class", "rmg", 4, "ngIf"], ["class", "rmg ", 4, "ngIf"], [1, "rmg"], [1, "text-center", "t"], [1, "btn", "btn-border", "btn-outline-warning", "text-light", 3, "click"], [1, "row", "container-fluid"], [1, "col-md-1", "rg"], [1, "col-md-9", "offset-2", "row", "rg"], [1, "form-group", "col-md-4"], ["id", "branch", 1, "form-control", 3, "ngModel", "ngModelChange"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "", 3, "selected"], [1, "form-group", "col-md-3", "offset-1"], ["type", "text", 1, "form-control", 3, "ngModel", "ngModelChange"], ["value", ""], [1, "col-md-2", "offset-2"], ["type", "button", 1, "btn", "btn-success", "text-center", 3, "click"], [1, "container-fluid", "row"], ["class", "card  mb-3 crd offset-1", "style", "max-width: 15rem;", 4, "ngFor", "ngForOf"], ["class", "error-message", 4, "ngIf"], [3, "value"], [1, "card", "mb-3", "crd", "offset-1", 2, "max-width", "15rem"], [1, "card-header", "text-dark"], [1, "card-body", "crd1"], [1, "card-text"], [1, "error-message"]],
    ...
    var UserLoggedInService = /*#__PURE__*/function () {
      ...
      _createClass(UserLoggedInService, [{
        ...
        value: function addBook(book, customerId) {
          return this.http.post("https://house-books1.herokuapp.com/book/book/" + customerId, book, {
            responseType: 'text'
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\proj\HouseOfBooks\Saved Pictures\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
